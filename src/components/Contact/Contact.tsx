    ...
    <section id="contact" className="relative py-12 md:py-24 overflow-hidden" style={{ backgroundColor: "#e8e4df" }} dir="rtl">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          {/* Form and Contacts */}
          <motion.div variants={staggerItem} className="flex flex-col gap-6 items-center lg:items-end w-full">
            <div className="flex flex-col items-center lg:items-end gap-4 w-full">
              ...
              <a href="mailto:service@avi-mashkanta.com" className="flex items-center gap-4 group w-full justify-center lg:justify-end">
