      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div variants={staggerItem} className="flex flex-col items-center lg:items-start text-center lg:text-right">
            <div className="relative w-full max-w-[420px]">
              ...
              <Link href="/wise" className="group inline-flex items-center gap-4 text-[#1c3664] font-black transition-all hover:opacity-80">
                ...
                <svg className="w-8 h-8 transform transition-transform group-hover:-translate-x-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <motion.div variants={staggerItem} className="flex flex-col items-center justify-center h-full">
            ...
            <span className="text-[#1c3664]/20 font-black text-6xl lg:text-8xl py-6 select-none leading-none">או</span>
            <div className="hidden lg:block h-32 w-[1.5px] bg-[#1c3664]/10"></div>
          </motion.div>
          ...
          <motion.div variants={staggerItem} className="flex flex-col gap-8 items-center lg:items-end w-full overflow-hidden">
            ...
            {/* Form Area */}
            <div className="w-full max-w-[420px] min-h-[320px] flex items-center">
