      ...
      <div className="container relative z-10 mx-auto px-6 max-w-7xl 2xl:max-w-[95rem] text-right">
        ...
        >
          ...
          <motion.p 
            ...
            className="text-base md:text-2xl lg:text-3xl text-white/90 font-light leading-relaxed max-w-6xl"
          >
            באותו רגע, התחושה היא שסומנתם ב"אות קין". שאתם "ברשימה השחורה". אז רגע לפני שאתם מתייאשים ומוותרים על הדירה, או רצים לקחת הלוואות בשוק האפור בריביות רצחניות - עצרו רגע, קחו נשימה, ותמשיכו לקרוא.
          </motion.p>
          ...
          >
            <p className="text-lg md:text-3xl lg:text-4xl text-white font-bold leading-snug">
              שמי אבי בוקעי, ואני מכיר את המערכת הזו מבפנים. כמי שעבד במערכת הבנקאית, אני יודע בדיוק מה הפקיד רואה על המסך כשהוא אומר לכם "לא". והחדשות הטובות? במקרים רבים, ה"לא" הזה הוא רק ההתחלה של משא ומתן, אם יודעים איך לנהל אותו.
            </p>
          </motion.div>
        </motion.div>
      </div>
