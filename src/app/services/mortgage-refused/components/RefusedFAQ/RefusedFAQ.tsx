...
const faqItems = [
  {
    question: "האם זה אומר שלעולם לא אקבל משכנתא?",
    answer:
      "ממש לא. נתוני האשראי השליליים נשמרים ל-3 שנים. אבל גם בתוך התקופה הזו, ניתן לקבל משכנתא אם יודעים להציג \"בטוחות\" חזקות או ערבים תומכים.",
  },
  {
    question: "האם הריבית שלי תהיה גבוהה יותר?",
    answer:
      "בכנות? כן. בגלל שהבנק רואה בכם \"סיכון\", הריבית הראשונית עשויה להיות גבוהה מהממוצע. אבל - וזה אבל חשוב: המטרה שלי היא להכניס אתכם לנכס. בעוד שנתיים, כשההתנהלות שלכם תהיה תקינה, אנחנו נבצע מיחזור משכנתא ונחזיר את הריביות לרמה רגילה. זה עדיף מלוותר על הדירה.",
  },
  {
    question: "האם אתה מטפל גם בפושטי רגל?",
    answer:
      "אלו מקרים מורכבים מאוד, אך יש פתרונות. גם לאחר פשיטת רגל (חדלות פירעון), ניתן לחזור למעגל האשראי לאחר תקופת צינון מסוימת ועם בנייה נכונה של פרופיל הלקוח.",
  },
];
...
export default function RefusedFAQ() {
