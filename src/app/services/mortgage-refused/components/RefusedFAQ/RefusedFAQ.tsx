...
const faqItems = [
  ...
  },
  {
    ...
    answer: (
      <>
        בכנות? כן. בגלל שהבנק רואה בכם "סיכון", הריבית הראשונית עשויה להיות גבוהה מהממוצע. אבל - וזה אבל חשוב: המטרה שלי היא להכניס אתכם לנכס. בעוד שנתיים, כשההתנהלות שלכם תהיה תקינה, אנחנו נבצע{" "}
