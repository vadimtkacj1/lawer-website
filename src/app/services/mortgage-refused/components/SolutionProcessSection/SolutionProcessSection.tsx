...
const steps = [
  ...
  { 
    ...
    d: "אם הדלת בבנק חסומה כרגע לחלוטין, אני יודע לתפור \"הלוואת גישור\" מגוף חוץ-בנקאי מוסדר או להשיג משכנתא למסורבים, לקנות את הדירה, ולמחזר את המשכנתא חזרה לבנק בעוד שנה-שנתיים כשהדירוג שלכם יתנקה." 
  }
];
