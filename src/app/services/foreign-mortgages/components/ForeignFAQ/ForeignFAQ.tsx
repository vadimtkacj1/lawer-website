...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "שאלה מצוינת. אם ההכנסה שלכם היא בדולר או ביורו, יש היגיון לשקול מסלול משכנתא צמוד למט\"ח כדי להימנע מסיכוני שער חליפין (שההחזר החודשי יקפוץ פתאום בשקלים). מצד שני, הריביות השקליות לעיתים אטרקטיביות יותר. אני בונה לכם תמהיל שמגן עליכם מתנודות מטבע קיצוניות.",
  },
  {
    question: "כמה זמן לוקח התהליך?",
    answer:
      "עבור תושבי חוץ, התהליך ארוך יותר מאשר לישראלים בגלל בדיקות הלבנת הון ואימות מסמכים. לכן קריטי לפנות אליי לפני שחותמים על חוזה הרכישה, כדי שנקבל אישור עקרוני מראש ולא תהיו בלחץ זמנים.",
  },
];
