...
// Foreign Residents FAQ data
const faqItems = [
  {
    question: "האם אני חייב להגיע לישראל פיזית כדי לקחת משכנתא?",
    answer:
      "ברוב השלבים – לא. את רוב התהליך (אישור עקרוני, מו\"מ על ריביות) אני מבצע עבורכם באמצעות ייפוי כוח. בדרך כלל תצטרכו להגיע פעם אחת לחתימות סופיות בבנק ופתיחת חשבון, או לבצע זאת באמצעות קונסוליה/ייפוי כוח נוטריוני ספציפי (תלוי במדיניות הבנק הספציפי).",
  },
  {
    question: "באיזה מטבע כדאי לקחת את המשכנתא?",
    answer:
      "שאלה מצוינת. אם ההכנסה שלכם היא בדולר או ביורו, יש היגיון לשקול מסלול משכנתא לתושבי חוץ צמוד למט\"ח כדי להימנע מסיכוני שער חליפין (שההחזר החודשי יקפוץ פתאום בשקלים). מצד שני, הריביות השקליות לעיתים אטרקטיביות יותר. אני בונה לכם תמהיל שמגן עליכם מתנודות מטבע קיצוניות.",
  },
  {
    question: "כמה זמן לוקח התהליך?",
    answer:
      "עבור מבקשי משכנתאות לתושבי חוץ, התהליך ארוך יותר מאשר לישראלים בגלל בדיקות הלבנת הון ואימות מסמכים. לכן קריטי לפנות אליי לפני שחותמים על חוזה הרכישה, כדי שנקבל אישור עקרוני מראש ולא תהיו בלחץ זמנים.",
  },
];
...
export default function ForeignFAQ() {
