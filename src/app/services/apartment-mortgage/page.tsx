...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://avi-home.co.il/services/apartment-mortgage",
  },
  openGraph: {
    title: "משכנתא לרכישת דירה בחולון והמרכז | אבי - הבית למשכנתאות",
    description: "משכנתא לרכישת דירה עם תמהיל מותאם אישית. ליווי מלא מאישור עקרוני ועד המפתח.",
    url: "https://avi-home.co.il/services/apartment-mortgage",
...
function JsonLd() {
  const structuredData = {
    ...
    "@graph": [
      {
        "@type": "Service",
        "@id": "https://avi-home.co.il/services/apartment-mortgage#service",
      ...
      {
        "@type": "WebPage",
        "@id": "https://avi-home.co.il/services/apartment-mortgage#webpage",
        url: "https://avi-home.co.il/services/apartment-mortgage",
        ...
        breadcrumb: {
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 3,
              name: "משכנתא לרכישת דירה",
              item: "https://avi-home.co.il/services/apartment-mortgage"
            }
          ]
        }
      }
