...
// המידע המעודכן של השאלות והתשובות
const faqItems = [
  {
    question: 'אבי, האם איחוד הלוואות לא מגדיל את סך החוב שלי בסופו של דבר?',
    answer:
      'שאלה מצוינת. כשפורסים הלוואה להרבה שנים, סך תשלום הריבית אכן עולה ("ריבית דריבית"). אבל, וזה אבל גדול – האלטרנטיבה היא להישאר במינוס שבו הריבית רצחנית, או לקרוס כלכלית. המטרה של איחוד הלוואות יציבות תזרימית עכשיו. במקרים רבים, החיסכון המיידי בריביות "הלא יעילות" (של האוברדרפט והאשראי) מקזז את העלות לטווח הארוך.',
  },
  {
    question: 'כמה עולה לבדוק אם כדאי לי לעשות מחזור משכנתא?',
    answer:
      'אצלי ב"אבי - הבית למשכנתאות", בדיקת הכדאיות הראשונית עבור מחזור משכנתא היא ללא עלות וללא התחייבות. אני מזין את הנתונים למחשבון, ואם אין חיסכון משמעותי – אני אהיה הראשון להגיד לכם "אל תיגעו במשכנתא".',
  },
  {
    question: 'האם חייבים להגיע לסניף הבנק?',
    answer:
      'את העבודה הקשה והבירוקרטיה של איחוד הלוואות או מחזור משכנתא אני עושה עבורכם מול הבנקים והמערכות הדיגיטליות. אתם מגיעים לחתימות הסופיות.',
  },
];
