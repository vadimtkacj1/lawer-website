...
const faqItems = [
  {
    ...
    answer:
      "ברוב המקרים כן. הבנק ירצה לראות שהכסף אכן הולך להשבחת הנכס ושערך הבית יעלה בעקבות השיפוץ. אני אדריך אתכם בדיוק מתי להזמין את השמאי ואיך להתכונן לביקור שלו.",
  },
  {
    question: "כמה כסף אני יכול לקבל לשיפוץ?",
    answer:
      "חשוב שתדעו: אם תפנו לבנק לבד, רוב הסיכויים שיגבילו אתכם ל-50% מימון משווי הנכס (כולל המשכנתא הקיימת), כי הבנקים בדרך כלל לא \"אוהבים\" לתת אחוזי מימון גבוהים לשיפוץ. אבל כאן הניסיון שלי נכנס לתמונה: הרגולציה בישראל מאפשרת להגיע עד 75% מימון. כמי שמכיר את המערכת מבפנים, אני יודע איך לבנות ולהגיש את הבקשה כדי למצות את הפוטנציאל המלא ולהשיג לכם את ה-70%-75% שמגיעים לכם, ולא להסתפק בברירת המחדל הנמוכה של הבנק.",
  },
  {
