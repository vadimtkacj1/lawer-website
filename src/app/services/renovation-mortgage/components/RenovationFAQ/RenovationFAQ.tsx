...
// Renovation-specific FAQ data
const faqItems = [
  {
    question: "האם אני חייב להביא שמאי?",
    answer:
      "ברוב המקרים של לקיחת משכנתא לשיפוץ בית, כן. הבנק ירצה לראות שהכסף אכן הולך להשבחת הנכס ושערך הבית יעלה בעקבות השיפוץ. אני אדריך אתכם בדיוק מתי להזמין את השמאי ואיך להתכונן לביקור שלו.",
  },
  {
    question: "כמה כסף אני יכול לקבל לשיפוץ?",
    answer:
      "חשוב שתדעו: אם תפנו לבנק לבד ותבקשו משכנתא לשיפוץ, רוב הסיכויים שיגבילו אתכם ל-50% מימון משווי הנכס (כולל המשכנתא הקיימת), כי הבנקים בדרך כלל לא \"אוהבים\" לתת אחוזי מימון גבוהים לשיפוץ. אבל כאן הניסיון שלי נכנס לתמונה: הרגולציה בישראל מאפשרת להגיע עד 75% מימון. כמי שמכיר את המערכת מבפנים, אני יודע איך לבנות ולהגיש את הבקשה כדי למצות את הפוטנציאל המלא ולהשיג לכם את ה-70%-75% שמגיעים לכם, ולא להסתפק בברירת המחדל הנמוכה של הבנק.",
  },
  {
    question: "האם הכסף נכנס ישר לחשבון שלי?",
    answer:
      "ברוב הבנקים, הנוהל הרגיל הוא לשחרר רק 50% מסכום השיפוץ בהתחלה, ואת ה-50% הנותרים רק בסיום השיפוץ או כנגד קבלות. זה יוצר לא פעם \"בור תזרימי\" מול הקבלנים שרוצים כסף עכשיו. היתרון שלי: הודות להיכרות שלי עם המערכת, במקרים רבים אני יודע לאשר שחרור של פעימה אחת מלאה עד 500,000 ₪ ישר לחשבון. זה נותן לכם שקט נפשי וכוח מיקוח אדיר מול הספקים, בלי לרדוף אחרי קבלות באמצע השיפוץ ובלי להיתקע בלי כסף.",
  },
];
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-10 items-start">
            ...
            {/* Left Column: Multi-line header based on image reference */}
            <div className="w-full lg:w-1/3 lg:sticky lg:top-24 self-start z-30">
              <div className="h-fit text-center lg:text-right">
                ...
                {/* Header text split into three lines, removing any dashes as requested */}
