...
const faqItems = [
  {
    question: "האם כדאי לקנות דירה ישנה בבת ים להשקעה?",
    answer:
      'בהחלט. בת ים מובילה את טבלת ההתחדשות עירונית בישראל. רכישת דירה ישנה באזורים עם פוטנציאל פינוי בינוי או תמ"א 38 יכולה להניב רווחי הון עצומים. אנו נלווה אתכם בבניית תמהיל מימון שייקח בחשבון את ההשבחה העתידית.',
  },
  {
    question: "האם כדי למחזר משכנתא אני חייב לגשת לסניף הבנק שלי בבת ים?",
    answer:
      "לא. כאשר אנו מבצעים עבורכם מחזור משכנתא בבת ים, אנו בודקים סניפים בכל רחבי הארץ. המטרה היא להביא לכם את ההצעה המשתלמת ביותר, ללא תלות במיקום הגיאוגרפי של סניף הבנק.",
  },
];
...
export default function BatYamFAQ() {
            ...
            <div className="w-full lg:w-1/3 lg:sticky lg:top-24 self-start z-30">
              <div className="h-fit text-center lg:text-right">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-blue-dk mb-3 sm:mb-4 md:mb-6 leading-[1.1] lg:leading-[1.05]">
                  שאלות נפוצות של רוכשים ומשקיעים בבת ים
                </h2>
              </div>
            </div>
