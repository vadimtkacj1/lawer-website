  ...
  return (
    ...
    >
      <div className="container relative z-10 mx-auto px-6 max-w-7xl text-right">
        ...
        >
          <m.div variants={staggerItem} className="mb-12 md:mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 mb-12 md:mb-20">
            <m.div variants={staggerItem} className="border-r-4 border-orange pr-6 md:pr-8">
          ...
          <m.div variants={staggerItem} className="bg-cream/10 backdrop-blur-sm rounded-3xl p-6 md:p-10 lg:p-12 border-2 border-orange/30 max-w-4xl mx-auto">
