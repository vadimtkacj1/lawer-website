...
// Updated FAQ data for Mortgage for Any Purpose
const faqItems = [
  {
    question: "האם אני מסכן את הבית שלי?",
    answer:
      "כל עוד עומדים בהחזרים החודשיים, הבית לא בסכנה. להפך - במקרים רבים, לקיחת הלוואות קצרות טווח שחונקות את העו״ש היא זו שמובילה לקריסה כלכלית. פריסה ארוכה במשכנתא לכל מטרה דווקא מייצרת יציבות וביטחון.",
  },
  {
    question: "כמה מהר אפשר לקבל את הכסף?",
    answer:
  ...
  {
    question: "האם אפשר לפרוע את ההלוואה לפני הזמן?",
    answer:
  ...
  {
    question: "למה לא פשוט לקחת הלוואה רגילה מהבנק?",
    answer:
