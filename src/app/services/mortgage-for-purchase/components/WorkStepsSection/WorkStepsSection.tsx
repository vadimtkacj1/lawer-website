...
const steps = [
  { 
    ...
    d: "אסור לחתום על חוזה רכישה לפני שיש אישור עקרוני מהבנק! זהו הצ'ק פתוח שלכם. אני מגיש עבורכם את הבקשה בצורה המקצועית ביותר כדי למקסם את גובה האישור, ולוודא שאתם לא מבזבזים זמן על דירות שאין לכם יכולת לממן." 
  },
  { 
    t: "אסטרטגיה ותכנון פיננסי", 
    d: "כאן נכנס היתרון האקדמי שלי. אנחנו לא סתם \"לוקחים כסף\". אנחנו מנתחים את העסקה: האם מחיר הדירה (במרכז או בפריפריה) ראלי? כמה הון עצמי כדאי להביא מהבית וכמה למנף מהבנק? האם צפויים להשתחרר כספים בעתיד (קרנות השתלמות)?" 
  },
  { 
    t: "מכרז ריביות (\"השוק\")", 
