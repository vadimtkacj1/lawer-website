...
export default function ReverseHero() {
  ...
  // Text animation on scroll - moves up and fades out
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 relative z-20">
        ...
        >
          <div className="w-full text-center space-y-6 lg:space-y-8">
            <motion.h1
              className="font-noto-sans-hebrew font-black leading-[1.15]
            ...
            >
             משכנתא הפוכה לגיל השלישי:
              <br/>איך להפוך את הבית לכסף נזיל
            </motion.h1>
          </div>
        </motion.div>
      </div>
