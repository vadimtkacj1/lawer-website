...
// Updated FAQ data based on your request
const faqItems = [
  {
    question: "מהי משכנתא הפוכה?",
    answer:
      "משכנתא הפוכה היא הלוואה שמאפשרת לנצל את ערך הבית שלכם, מבלי לוותר על הבעלות או לעבור דירה. הכסף ניתן לשימוש אישי, ולרוב אין צורך בהחזר חודשי – החוב נצבר ומשולם רק במכירת הבית או באמצעים אחרים.",
  },
  {
    question: "מי זכאי למשכנתא הפוכה?",
    answer:
      "הלוואה זו מיועדת לבעלי נכס מעל גיל 55 – יחיד או זוג (גם הצעיר מבין הזוג צריך להיות מעל גיל 55). הנכס שברשותכם משמש כבטוחה להלוואה.",
  },
  {
    question: "למה כדאי לקחת משכנתא הפוכה דווקא עם יועץ פרטי?",
    answer:
      "יועץ פרטי בונה את העסקה לפי האיפיון הכלכלי שלכם, בודק חלופות זולות יותר, שומר על הנכס שתרצו להשאיר לילדים ומטפל בבירוקרטיה – כך שאתם מקבלים תכנון מותאם אישית ושקט נפשי.",
  },
  {
    question: "האם חייבים להחזיר כסף מיד?",
    answer:
      "לא. ברוב המקרים אין החזרים חודשיים. ניתן לשלם ריבית בלבד או להחזיר קרן וריבית, לפי המסלול שתבחרו. ההלוואה נפרעת בדרך כלל בעת מכירת הבית או באמצעים אחרים.",
  },
  {
    question: "מה אפשר לעשות עם הכסף?",
    answer:
      "אתם מחליטים לגמרי: לשפץ את הבית, לסגור חובות, לעזור לילדים, לטייל בעולם או למטרות אחרות. ניתן לקבל את הכסף כסכום חד-פעמי, כקצבה חודשית או כמסגרת אשראי.",
  },
  {
    question: "האם משכנתא הפוכה מתאימה לכולם?",
    answer:
      "לא תמיד. החוב מצטבר לאורך הזמן, ולכן חשוב לשקול את ההלוואה בכובד ראש, במיוחד אם המטרה היא להשאיר נכס נקי לילדים. ייעוץ מקצועי מסייע להבין אם זו האפשרות הנכונה לכם.",
  },
  {
    question: "כמה ניתן לקבל?",
    answer:
      "סכום ההלוואה נע בין 20% ל־60% משווי הבית, בהתאם לגיל הלווים ולערך הנכס. ניתן לפרוע את ההלוואה בכל עת",
  },
];
...
export default function ReverseFAQ() {
  ...
  return (
    <section 
      ...
      style={{ backgroundColor: "#FAF7F2" }} // Updated to the cream background used in other sections
    >
