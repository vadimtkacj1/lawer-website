        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
          ...
          <motion.div variants={staggerItem} className="mb-14 md:mb-20">
            ...
            <h3 className="font-noto-sans-hebrew font-bold text-2xl md:text-4xl lg:text-5xl text-orange leading-tight">
              הבנק רואה את הדירה שלכם כ"שווה יותר"
            </h3>
          </motion.div>
          ...
          >
            <p className="text-lg md:text-2xl lg:text-3xl text-[#1c3664]/80 font-light leading-relaxed">
              זה היתרון הכי גדול של התוכנית, והרבה זוכים לא מבינים אותו עד הסוף. במשכנתא רגילה, הבנק נותן מימון לפי המחיר בחוזה. ב"דירה בהנחה", הבנק רשאי לתת לכם מימון לפי שווי השוק האמיתי של הדירה (לפי הערכת שמאי), ולא לפי המחיר המוזל ששילמתם בפועל (בכפוף למגבלות רגולציה מסוימות).
            </p>
            ...
            >
              ...
              <p className="text-lg md:text-2xl text-[#1c3664] font-medium leading-relaxed">
                זה מאפשר לכם להביא <span className="font-black text-orange">הון עצמי נמוך משמעותית</span> מהבית. בעוד שבשוק החופשי זוג צריך להביא 25% מהבית, ב"דירה בהנחה" ניתן לעיתים להגיע למצב שבו אתם מביאים סכום התחלתי קטן מאוד (למשל 100,000 ש"ח או 10%), ואת כל השאר הבנק מממן.
              </p>
            </motion.div>
