...
const reasons = [
  {
    ...
    description: "כיוצא מערכת הבנקאות וכיועץ משכנתא מנוסה, אני מכיר את המערכת מבפנים ומבחוץ. אני יודע איפה אפשר ללחוץ, על מה אפשר לוותר, ואיך להגיש תיק בצורה שתאושר מיד. אין \"ניסוי וטעייה\" – יש עבודה יעילה מול מקבלי ההחלטות בסניפים."
  },
  {
    number: "2",
    icon: AwardIcon,
    title: "יתרון אקדמי בנדל\"ן",
    description: " בתחום של ייעוץ משכנתאות, בניגוד ליועצים רבים, אני מגיע עם תואר ראשון במנהל עסקים והתמחות בנדל\"ן ותשתיות, ופועל על פי הסטנדרטים המחמירים של התאחדות יועצי משכנתאות. אני רואה את המשכנתא שלכם כחלק מתיק השקעות כולל, ובונה אותה בראייה כלכלית רחבה ואחראית שמסתכלת שנים קדימה."
  },
  {
    number: "3",
    icon: SettingsIcon,
    title: "בירוקרטיה? עלי.",
    description: "אני יודע שאין לכם זמן לרדוף אחרי פקידי משכנתאות. מרגע שיוצאים לדרך, אני הופך ל\"מגן\" שלכם. אני מטפל בניירת, בשמאים, בעורכי הדין ובאישורים, כדי שאתם תגיעו רק לחתימה הסופית."
  }
];
