    ...
    >
      ...
      <div className="container mx-auto px-6 sm:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          {/* Expert Image */}
          <motion.div
            className="w-full max-w-[280px] sm:max-w-[350px] lg:max-w-none flex-1 mx-auto lg:mx-0 will-change-transform"
          ...
          <div className="flex-[1.3] text-center lg:text-right w-full">
            ...
            {/* FIXED LIST ALIGNMENT:
              - Added 'flex justify-center lg:justify-start' wrapper to center the whole list on mobile
              - 'items-start' keeps the icons perfectly aligned in a vertical line
            */}
            <div className="flex justify-center lg:justify-start mb-10">
              <motion.ul
                className="inline-flex flex-col items-start space-y-4 text-right"
                initial={initialPresence}
                whileInView="visible"
                viewport={isMobile ? mobileViewport : viewportOptions}
