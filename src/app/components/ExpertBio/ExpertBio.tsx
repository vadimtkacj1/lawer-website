        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-[1.4] text-center lg:text-right w-full">
            ...
            <motion.p
              ...
              variants={fadeInUpFast}
            >
              אני אבי בוקעי, יוצא המערכת הבנקאית ובעל תואר אקדמי במנהל עסקים עם דגש על נדל"ן. אני כאן כדי ללוות אתכם צעד-צעד בבחירות הכלכליות החשובות שלכם, ולחסוך לכם את הבירוקרטיה והכסף שהבנק לא רוצה שתחסכו.
         </motion.p>
