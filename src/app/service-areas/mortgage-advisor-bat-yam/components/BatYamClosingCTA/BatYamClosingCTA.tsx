...
export default function BatYamClosingCTA() {
  return (
    <section dir="rtl" className="relative py-16 md:py-24 lg:py-32 bg-[#1c3664] overflow-hidden">
      <div className="container relative z-10 mx-auto px-6 max-w-7xl 2xl:max-w-[95rem] text-right">
        ...
        >
          ...
          >
            אל תשאירו את העסקה היקרה בחייכם ליד המקרה. צרו קשר עוד היום עם יועץ משכנתאות בבת ים שידאג נטו לאינטרסים שלכם ויחסוך לכם מאות אלפי שקלים. השאירו פרטים ונחזור אליכם לשיחת היכרות ללא התחייבות.
          </motion.p>
