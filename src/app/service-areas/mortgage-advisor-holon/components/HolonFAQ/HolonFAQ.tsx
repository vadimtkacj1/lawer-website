...
const faqItems = [
  {
    question: "האם אני חייב לקחת משכנתא בסניף בנק בחולון?",
    answer:
      "ממש לא. כשאנחנו יוצאים למכרז ריביות, אנחנו לא מוגבלים גיאוגרפית כלל. אני בודק סניפים בכל אזור המרכז, ואפילו ברמה הארצית, כדי להביא לכם את ההצעה הטובה והזולה ביותר. התפקיד שלי הוא לדאוג שתקבלו את הכסף בתנאים שלכם, מאיזה סניף שזה לא יהיה.",
  },
  {
    question: "כמה הון עצמי צריך לדירה ממוצעת בחולון?",
    answer:
      'עבור קניית דירה ראשונה תידרשו למינימום 25% הון עצמי. עם זאת, לאור מחירי הנדל"ן שעולים באזורים המבוקשים בעיר, חשוב לבצע תכנון מקדים ומדויק כדי לוודא שיש לכם את הסכום הדרוש לא רק למשכנתא עצמה, אלא גם להוצאות הנלוות (שמאי, עו"ד, מיסים, תיווך).',
  },
];
...
export default function HolonFAQ() {
            ...
            <div className="w-full lg:w-1/3 lg:sticky lg:top-24 self-start z-30">
              <div className="h-fit text-center lg:text-right">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-blue-dk mb-3 sm:mb-4 md:mb-6 leading-[1.1] lg:leading-[1.05]">
                  שאלות נפוצות של רוכשי דירות בחולון
                </h2>
              </div>
            </div>
